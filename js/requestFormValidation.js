...
function formValidation() {
    ...
    if(!bloodPound.value.match(/\d$/)){
        document.getElementById("rBloodPoundErr").innerHTML="* Blood Pound quantity should be in number";
        return false;
    }

    if(bloodPound.value.length < 1){
        document.getElementById("rBloodPoundErr").innerHTML="* Blood pound quantity cant be negative";
        return false;
    }

    if(bloodPound.value.length > 10){
